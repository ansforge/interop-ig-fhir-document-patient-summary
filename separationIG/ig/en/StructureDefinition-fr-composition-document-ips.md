...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.fr-patient-summary|current/StructureDefinition/StructureDefinition-fr-composition-document-ips.json)
