...
```json
{
  ...
  "id" : "ans.fhir.fr.fr-patient-summary",
  "language" : "fr",
  ...
  "description" : "Volet de Synthèse Médicale (International Patient Summary) - Spécifications FHIR",
  "jurisdiction" : [{
    "coding" : [{
  ...
  "packageId" : "ans.fhir.fr.fr-patient-summary",
  "license" : "CC0-1.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://interop.esante.gouv.fr/ig/fhir/fr-patient-summary/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
