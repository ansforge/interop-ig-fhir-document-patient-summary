...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/ans.fhir.fr.fr-patient-summary|current/StructureDefinition/fr-lm-patient-summary-document)
